// Компонет - строительный блок, который используется для 
// разделения масштабного кода, далее компонент должен быть подключен
// в index.js, чтобы быть отображенным в html

// JSX - html+js

// Функционлаьный компонент - функция, которая возвращает html
...
const App = () => {
    ...
    let hamburgerButtons = [
        ...
        { text: 'tomato', img: Tomato, price: 30 },
        { text: 'salad', img: Salad, price: 30 }
    ]
    return (
...
// [states, server calls] --> будет работает каждый раз, 
